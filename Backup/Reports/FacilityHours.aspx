<%@ Page Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="FacilityHours.aspx.cs" Inherits="InterrailPPRS.Reports.FacilityHours" %>
                                ...
                                <table width="91%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td colspan="8" class="pageTitle" align='center'>
                                      ...
                                      <% if (Request["LastWeek"] == "Yes" ){ %>
                                      Facility Payroll Entry Last Pay Week
                                      <% }else{ %>
                                      Facility Payroll Entry Current Pay Week
                                      <% }  %>
                                  ...
                                  <tr>
                                    <td colspan="8"  align='center'>
                                      ...
                                      <% if (Request["LastWeek"] == "Yes"){ %>
                                      <a href="FacilityHours.aspx?LastWeek=No">Show This Week</a>
                                      <% }else{ %>
                                      <a href="FacilityHours.aspx?LastWeek=Yes">Show Last Week</a>
                                      <% }  %>
                                      </div>
                                    </td>
                                  </tr>

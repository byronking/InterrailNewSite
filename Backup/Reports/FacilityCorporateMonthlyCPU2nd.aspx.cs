...
{
    public partial class FacilityCorporateMonthlyCPU2nd : PageBase
    {
        ...
        public DataReader rsSpotting, rsTrainingHours, rsClericalHours, rsRBHours, rsUAHours, rsSelfAudit, rsKPI, rsBudgetCPUTU, rsBudgetCPURH, rsBudgetCPUOT, rsATHours, rsATUnits, rsPrepHours, rsPrepUnits, rsTotalUnits;
        ...
        public void WriteTopRows(){
          ...
          string rc,UnLoadUnits,UnLoadHours,LoadUnits,LoadHours;
          string sUM,sUM1,sUM2,sUM3,RC_Hr;
          string shuttlingUnits, shuttlingHours, spotting1, spotting2, spotting3, spottingHours, trainingHours, clericalHours, RBHours, UAHours;

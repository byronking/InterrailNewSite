...
{
    public partial class RebillSubTask : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            rsRebill = new DataReader("SELECT r.Id, r.TaskID, r.Description, r.FacilityCustomerId, r.LastModifiedBy, r.LastModifiedOn,    dbo.Tasks.TaskCode, dbo.Tasks.TaskDescription  FROM dbo.Tasks INNER JOIN  dbo.RebillSubTasks r ON dbo.Tasks.Id = r.TaskID LEFT OUTER JOIN                        dbo.Facility f INNER JOIN                        dbo.FacilityCustomer fc ON f.Id = fc.FacilityId ON r.FacilityCustomerId = fc.Id  WHERE (f.Id = " + Replace(rsRebill__PFacilityID, "'", "''") + ")");
            rsRebill.Open();
            rsRebill_numRows = 0;
            ...
            MM_rs    = rsRebill;
            MM_rsCount   = rsRebill_total;
            MM_size      = rsRebill_numRows;
            string MM_uniqueCol = "";
            MM_paramName = "";
            MM_offset = 0;
            MM_atTotal = false;

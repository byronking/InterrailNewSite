<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="InterrailPPRS.Admin.Settings" %>
 ...
 <table width="90%" border="0" cellspacing="0" cellpadding="8">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="85%">
            ...
            <td align="default" colspan="3"> 
                <div align="center" class="pageTitle">Settings</div>
            </td>
            </tr>
            ...
            <tr> 
            <td align="default" width="23%">&nbsp;</td>
            <td align="default" width="37%">Database:</td>
            <td align="default" width="40%">
               <asp:RadioButton ID="rdoDB_Production" runat="server" GroupName="db_Path" 
                    Text="Production" oncheckedchanged="rdoDB_Production_CheckedChanged" 
                    AutoPostBack="True" />
               <asp:RadioButton ID="rdoDB_Archive" runat="server" GroupName="db_Path" 
                    Text="Archive" oncheckedchanged="rdoDB_Archive_CheckedChanged" 
                    AutoPostBack="True" />

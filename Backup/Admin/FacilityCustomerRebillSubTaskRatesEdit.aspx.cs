...
{
    public partial class FacilityCustomerRebillSubTaskRatesEdit : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            // *** Update Record: variables;
              ...
              string MM_editTable = "dbo.FacilityCustomerRebillSubTaskRate";
              string MM_editColumn = "Id";
              string MM_recordId = "" + Request.Form["MM_recordId"] + "";
              string MM_editRedirectUrl = "FacilityCustomerRebillSubTaskRates.aspx?Id=" + Request["FacilityCustomerRebillSubTaskId"];
              string MM_fieldsStr  = "EffectiveDate|value|Rate|value|RateType|value|ExpirationDate|value|LastModifiedOn|value|LastModifiedBy|value|FacilityCustomerRebillSubTaskId|value";
              string MM_columnsStr = "EffectiveDate|',none,''|RebillRate|none,none,NULL|RebillType|',none,''|ExpirationDate|',none,NULL|LastModifiedOn|',none,NULL|LastModifiedBy|',none,''|FacilityCustomerRebillSubTasksId|none,none,NULL";
        ...
        if(cStr(Request["ID"]) == "0"){
          ...
          //strSQL = "SELECT * FROM dbo.FacilityCustomerRebillSubTaskRate WHERE Id =-1 ";
          //rsRebill.CursorLocation = 3;
          //rsRebill.Open strSQL, MM_Main_STRING, 1, 3, 1;
          //rsRebill.AddNew;
            rsRebill = new DataReader();
        }else{
          rsRebill = new DataReader("SELECT Id, FacilityCustomerRebillSubTasksId, EffectiveDate, RebillRate, RebillType, ExpirationDate, LastModifiedBy, LastModifiedOn  FROM dbo.FacilityCustomerRebillSubTaskRate  WHERE Id = " + Replace(rsRebill__MM_ColParam, "'", "''") + "");
          rsRebill.Open();
          rsRebill_numRows = 0;
        }

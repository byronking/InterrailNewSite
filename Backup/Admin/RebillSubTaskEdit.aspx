<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RebillSubTaskEdit.aspx.cs" Inherits="InterrailPPRS.Admin.RebillSubTaskEdit" %>
...
function goCancel()
{
  try
    {
      self.location = "RebillSubTask.aspx";
    }
  catch(e)
    {};
}
...
<table width="90%" border="0" cellspacing="0" cellpadding="8">
        <tr> 
            ...
            <% if ((rsTasks.EOF) || (rsCustomer.EOF)) { %>
            No tasks and/or customers available for the facility.<br>
            Please assign tasks and/or customers first.
            <% }else{ %>
            <form method="POST" ACTION="<%=MM_editAction%>" name="form1">
                ...
                <tr valign="baseline">
                    ...
                    <td>
                    <select name="selHoursOrUnits" style="width:65px">
                        <option value="H" <%if (Trim(rsRebill.Item("HoursOrUnits")) == "H") { Response.Write("SELECTED"); }else{ Response.Write(""); }%>>Hourly</option>
                        <option value="U" <%if (Trim(rsRebill.Item("HoursOrUnits")) == "U") { Response.Write("SELECTED"); }else{ Response.Write(""); }%>>Units</option>
                    </select>
                    </td>
                </tr>

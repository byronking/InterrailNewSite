...
{
    public partial class FacilityHours : PageBase
    {
        ...
        public int  MoveDate;
            ...
            public DataReader getData() {
                ...
                strSQL +=  "           ) as Thursday ";
                strSQL +=  "  from Facility Where Facility.Active = 1";
            ...
            public void ShowData(){
                ...
                Response.Write("<tr class='" + ic + "'><td align='left'>" + rs.Item("Facility") + "</td><td align='right'>");

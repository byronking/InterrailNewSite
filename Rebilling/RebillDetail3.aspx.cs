...
{
    public partial class RebillDetail : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            rs = new DataReader("SELECT  dbo.RebillDetail.Id, dbo.RebillDetail.WorkDate, dbo.RebillDetail.Rebilled,dbo.RebillDetail.TotalHours, dbo.RebillDetail.RebillStatus, dbo.RebillSubTasks.Description,  dbo.Tasks.TaskCode, dbo.FacilityCustomer.CustomerCode, dbo.FacilityCustomer.CustomerName  FROM  dbo.RebillDetail INNER JOIN  dbo.RebillSubTasks ON dbo.RebillDetail.RebillSubTasksId = dbo.RebillSubTasks.Id INNER JOIN  dbo.Tasks ON dbo.RebillSubTasks.TaskID = dbo.Tasks.Id INNER JOIN dbo.FacilityCustomer ON dbo.RebillSubTasks.FacilityCustomerId = dbo.FacilityCustomer.Id  WHERE RebillDetail.FacilityID=" + Replace(rs__PFacilityID, "'", "''") + "  ORDER BY WorkDate DESC, dbo.RebillDetail.Id DESC");
            rs.Open();

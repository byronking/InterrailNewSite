    ...
    public partial class RebillReports : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            base.Page_Load(sender, e);
                ...
                rsTask__PUserID = "1";
                if (Session["UserID"] != "") { rsTask__PUserID = cStr(Session["UserID"]);}


                string rsTask__PUserType;
                rsTask__PUserType = "admin";
                if (Session["UserType"] != "") { rsTask__PUserType = cStr(Session["UserType"]);}
                ...
                if (Session["UserType"] != "") { rsCustomers__PUserType = cStr(Session["UserType"]);}


                string rsCustomers__PUserID;
                rsCustomers__PUserID = "1";
                if (Session["UserID"] != "") { rsCustomers__PUserID = cStr(Session["UserID"]);}

<%@ Page Language="C#" MasterPageFile="~/Rebilling/Rebilling.Master" AutoEventWireup="true" CodeBehind="RebillEntry.aspx.cs" Inherits="InterrailPPRS.Rebilling.RebillEntry" %>
...
<script type="text/javascript" >
    ...
    function goDetail() {
        ...
        document.frmPrint.action = "RebillEntryDetail.aspx";
        ...
        <tr>
            ...
            <form name='frmPrint' method='post' action=''>
                ...
                <tr>
                    ...
                    <div class="cellTopBottomBorder">Rebill Entry</div>
                    </td>
                </tr>
                <tr>

<%@ Page Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="FacilityRegionalMonthlyCPU.aspx.cs" Inherits="InterrailPPRS.Reports.FacilityRegionalMonthlyCPU" %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=930 style='border-collapse: collapse;'>
 <tr height=10 style='height:10pt'>
  ...
  <td colspan=23 class=xl2222222 align='center'><br><br><B>Facility Monitoring System<br>Year of <%=selYear%><br><%=regionName%>&nbsp;Region</b>
  </td>
 </tr>

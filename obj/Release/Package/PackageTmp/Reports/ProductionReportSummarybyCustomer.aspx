<%@ Page Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="ProductionReportSummarybyCustomer.aspx.cs" Inherits="InterrailPPRS.Reports.ProductionReportSummarybyCustomer" %>
                      ...
                      <table width="90%" border="0" cellspacing="0" cellpadding="8">
                        <tr>
                          <td valign="top"><!-- #BeginEditable "MainBody" -->
                            <% ShowProductionReportSummarybyCustomer();  %>
                            <!-- #EndEditable -->
                          </td>
                        </tr>
                    </table>

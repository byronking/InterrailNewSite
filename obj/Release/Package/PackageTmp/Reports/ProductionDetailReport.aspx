<%@ Page Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="ProductionDetailReport.aspx.cs" Inherits="InterrailPPRS.Reports.ProductionDetailReport" %>
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="8">
        <tr>
            <td valign="top"><!-- #BeginEditable "MainBody" -->
                <% ShowProductionDetailReport();%>
                <form name="form1" method="get" action="ProductionDetailReport.aspx">
                    ...
                    <input type="hidden" name="selOrigins"       value='<%= sselOrigins %>'       >
                    <input type="hidden" name="selManufacturers" value='<%= sselManufacturers %>' >
                    <input type="hidden" name="SelectedShifts" value='<%=sSelectedShifts %>' >
                </form>
                <!-- #EndEditable -->
            </td>
        </tr>

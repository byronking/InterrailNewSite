<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UserFacilityAccess.aspx.cs" Inherits="InterrailPPRS.Admin.UserFacilityAccess" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="Main" runat="server">
    ...
    <tr>
        ...
        <form name="form1" method="POST" action="<%=MM_editAction%>">
            <table width="100%" bborder="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="3">
                <div align="center" class="pageTitle"><b>Facility
                    Permissions for <%=(rsUserName.Item("UserName"))%></b></div>
                </td>
            </tr>
            <tr>
                <td width="10%">&nbsp;</td>
            ...
            <tr class="<%=rowColor%>">
                <td width="10%">
                <div align="right">
                    <input <%if (rs.Item("UserProfileId") == rsUserName.Item("Id")) { Response.Write("CHECKED"); }else{ Response.Write("");} %> type="checkbox" name="checkbox" value='<%=rs.Item("Id") %>' >
                </div>
                </td>
                <td width="47%" align="left"><%=(rs.Item("Name")) %></td>
                <td width="43%">
                <% if (rs.Item("UserProfileId") == rsUserName.Item("Id")) { %>
                Added <%=(rs.Item("LastModifiedOn")) %> By <%=(rs.Item("LastModifiedBy")) %>
                <% } %>
                </td>
            </tr>
            <%
            ...
            <tr>
                ...
                <input type="hidden" name="MM_recordId" value="<%=(rsUserName.Item("Id")) %>" />
                </td>
                <td colspan="2">
                <p>&nbsp;</p>
                <p>

<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RebillSubTaskRates.aspx.cs" Inherits="InterrailPPRS.Admin.RebillSubTaskRates" %>
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="8">
        <tr> 
            ...
            <table align="center"  border="0" cellspacing="0" cellpadding="0" width="94%">
                ...
                <tr>
                <td align="default" width="35%" height="21">&nbsp;</td>
                <td align="default" width="35%" height="21">&nbsp;</td>
                <td align="default" width="15%" height="21">&nbsp;</td>
                <td align="default" width="15%" height="21">&nbsp;</td>
                </tr>
                <tr>
                <td align="default" width="30%">&nbsp;</td>
                <td align="default" colspan="3">
                    <div align="right"><a href="RebillSubTaskRatesEdit.aspx?id=0&RBTask=<%=Request.QueryString["ID"] %>">Add New Rebill Task Rate</a></div>
                </td>
                </tr>
                <tr>
                <td align="default">&nbsp;</td>
                ...
                <tr>
                <th align="default"  class="cellTopBottomBorder">
            ...
            %>
                ...
                <tr class="<%=rowColor%>">
                <td align="left" >
                    <a href="RebillSubTaskRatesEdit.aspx?<%= MM_keepForm + MM_joinChar(MM_keepForm) + "Id=" + rsRebill.Item("Id") + "&RBTask=" + Request.QueryString["ID"] %>"><%=(rsRebill.Item("EffectiveDate"))%></a> </td>
                <td align="left"><%=(rsRebill.Item("ExpirationDate"))%></td>
                <td align="left"><%= FormatNumber((rsRebill.Item("RebillRate")), 2, -2, -2, -2) %></td>
                <% if (rsRebill.Item("HoursOrUnits") == "H") { %>
                <td align="default">Hours</td>
                <% }else{ %>
                <td align="default">Units</td>
                <% } %>
                </tr>
                <%

<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FacilityCustomerRebillSubTaskRatesEdit.aspx.cs" Inherits="InterrailPPRS.Admin.FacilityCustomerRebillSubTaskRatesEdit" %>
...
{
  frm = document.form1;
  if (ValidNumber(frm.Rate,                1, "Rate")          != true) {return false;}
  if (ValidText(frm.RateType,                     1, "Rate Type")       != true) {return false;}
...
function goCancel()
{
  try
   {
     self.location = "FacilityCustomerRebillSubTaskRates.aspx?Id=<%=Request["RBTask"]%>";
   }
  catch(e)
   {};
}
                            ...
                            <form method="POST" action="<%=MM_editAction%>" name="form1">
                              <table align="center">
                                ...
                                <tr valign="baseline"> 
                                  ...
                                  <td> 
                                    <input type="text" name="Rate" value="<%= FormatNumber((rsRebill.Item("RebillRate")), 2, -2, -2, -2) %>" size="32" maxlength="10">
                                  </td>
                                </tr>
                                <tr valign="baseline"> 
                                  <td nowrap align="right" class="required">Rate 
                                    Type :</td>
                                  <td> 
                                    <input type="text" name="RateType" value="<%= Trim((rsRebill.Item("RebillType"))) %>" size="32" maxlength="30">
                                  </td>
                                </tr>
                                <tr valign="baseline"> 
                              ...
                              <%if (Request["ID"] == "0")
                                { %>
                              <input type="hidden" name="FacilityCustomerRebillSubTaskId" value="<%=Request["RBTask"]%>">
                              <% }
                                else
                                { %>
                              <input type="hidden" name="FacilityCustomerRebillSubTaskId" value="<%= rsRebill.Item("FacilityCustomerRebillSubTasksId") %>">
                              <% } %>
                            </form>
                            <p>&nbsp;</p>

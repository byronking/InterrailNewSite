...
namespace InterrailPPRS.Admin
{
    public partial class User : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            #region Old user list code
            //rs  = new DataReader("SELECT Id, UserID, UserName, UserType, UserLongName, LastModifiedBy, LastModifiedOn FROM dbo.UserProfile ORDER BY UserName ASC");
            //rs.Open();
            //rs_numRows = 0;

<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UserFacilityMonitor.aspx.cs" Inherits="InterrailPPRS.Admin.UserFacilityMonitor" %>
        ...
        <form name="form1" method="POST" action="<%=MM_editAction%>">
            ...
            <tr>
                ...
                <div align="center" class="pageTitle"><b>Facility
                    Monitoring Rights for <%=(rsUserName.Item("UserName"))%></b></div>
                </td>
            </tr>
            <tr>
                <td width="10%">&nbsp;</td>

...
{
    public partial class EmploymentSource : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            rs = new DataReader("SELECT Id, FacilityId, SourceCode, SourceName,  LastModifiedBy, LastModifiedOn, Active  FROM dbo.EmploymentSource  WHERE FacilityID=" + Replace(rs__PFacilityID, "'", "''") + "  ORDER BY SourceName ASC");
            rs.Open();
            rs_numRows = 0;

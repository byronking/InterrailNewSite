...
{
    public partial class FacilityCustomerRebillSubTaskRates : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            string rsRebill__MMColParam;
            rsRebill__MMColParam = "1";
            if (Request.QueryString["ID"] != "") { rsRebill__MMColParam = Request.QueryString["ID"]; }

              GrantAccess("Super, Admin, User");

            rsRebill = new DataReader("SELECT Id, FacilityCustomerRebillSubTasksId, EffectiveDate, RebillRate, RebillType, ExpirationDate, LastModifiedBy, LastModifiedOn FROM dbo.FacilityCustomerRebillSubTaskRate WHERE FacilityCustomerRebillSubTasksId = " + Replace(rsRebill__MMColParam, "'", "''") + "");
            rsRebill.Open();
            rsRebill_numRows = 0;
            ...
            Repeat1__numRows = 10;
            Repeat1__index = 0;
            rsRebill_numRows = Repeat1__numRows;
            ...
            if(!MM_paramIsDefined && MM_rsCount != 0){
              ...
              if(MM_rs.EOF){
                  MM_offset = i; 
                  // MM_offset to the last possible record;
              }

<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RebillSubTask.aspx.cs" Inherits="InterrailPPRS.Admin.RebillSubTask" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        <tr> 
            ...
            <table align="center"  border="0" cellspacing="0" cellpadding="0" width="94%">
                ...
                <td align="default" width="30%" height="21">&nbsp;</td>
                <td align="default" width="25%" height="21">&nbsp;</td>
                </tr>
                <tr>
                <td align="default" width="25%">&nbsp;</td>
                <td align="default" colspan="2"> <div align="right"><a href="RebillSubTaskEdit.aspx?id=0">Add New Rebill Task</a></div>
                </td>
                </tr>
                <tr>
                ...
                <th align="default" width="30%" class="cellTopBottomBorder">
                ...
                %>
                <tr class="<%=rowColor%>">
                <td align="left" width="50%"><a href="RebillSubTaskEdit.aspx?<%= MM_keepForm + MM_joinChar(MM_keepForm) + "Id=" + rsRebill.Item("Id") %>"><%=(rsRebill.Item("Description"))%></a> </td>
                <td align="left" width="30%"><%=(rsRebill.Item("TaskDescription"))%> (<%=(rsRebill.Item("TaskCode"))%>) </td>
                <td align="left" width="25%"><a href="RebillSubTaskRates.aspx?ID=<%=(rsRebill.Item("Id"))%>">Rates</a></td>
                </tr>
                <%

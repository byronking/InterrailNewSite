...
{
    public partial class RebillSubTaskRates : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            rsRebill = new DataReader( "SELECT Id, RebillSubTasksId, EffectiveDate, HoursOrUnits, RebillRate, RebillType, ExpirationDate, LastModifiedBy, LastModifiedOn FROM dbo.RebillSubTaskRates WHERE RebillSubTasksId = " + Replace(rsRebill__MMColParam, "'", "''") + "");
            rsRebill.Open();

...
{
    public partial class FacilityTaskEdit : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            // *** Update Record: variables;
              ...
              string MM_editTable = "dbo.FacilityTask";
              string MM_editColumn = "Id";
              string MM_recordId = "" + Request.Form["MM_recordId"] + "";
              string MM_editRedirectUrl = "FacilityTask.aspx";
              string MM_fieldsStr  = "TaskCode|value|TaskDescription|value|RebillableTask|value|select2|value|GLAcctNumber|value|Active|value|LastModifiedOn|value|LastModifiedBy|value|FacID|value";
              string MM_columnsStr = "TaskCode|',none,''|TaskDescription|',none,''|RebillableTask|none,1,0|PayType|',none,''|GLAcctNumber|',none,''|Active|none,1,0|LastModifiedOn|',none,''|LastModifiedBy|',none,''|FacilityId|none,none,NULL";
            ...
            if(cStr(Request["ID"]) == "0"){
              ...
              //strSQL = "SELECT * FROM dbo.FacilityTask WHERE Id =-1 ";
              //rs.CursorLocation = 3;
              ...
              rs = new DataReader( "SELECT Id, FacilityId, TaskCode, TaskDescription, RebillableTask, PayType, GLAcctNumber, LastModifiedBy, LastModifiedOn, Active  FROM dbo.FacilityTask  WHERE Id = " + Replace(rs__MMColParam, "'", "''") + "  ORDER BY TaskDescription ASC");
              rs.Open();
              rs_numRows = 0;
            }

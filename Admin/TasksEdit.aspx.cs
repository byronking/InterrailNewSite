...
{
    public partial class TasksEdit : PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            // *** Update Record: variables;
              ...
              string MM_editTable = "dbo.Tasks";
              string MM_editColumn = "Id";
              string MM_recordId = "" + Request.Form["MM_recordId"] + "";
              string MM_editRedirectUrl = "Tasks.aspx";
              string MM_fieldsStr  = "TaskCode|value|TaskDescription|value|GLAcctNumber|value|rebillable|value|select2|value|Active|value|LastModifiedOn|value|LastModifiedBy|value";
              string MM_columnsStr = "TaskCode|',none,''|TaskDescription|',none,''|GLAcctNumber|',none,''|Rebillable|none,1,0|PayType|',none,''|Active|none,1,0|LastModifiedOn|',none,''|LastModifiedBy|',none,''";
            ...
            if(Request["ID"] == "0"){
              ...
              //strSQL = "SELECT * FROM dbo.Tasks WHERE Id =-1 ";
              //rs.CursorLocation = 3;
              ...
              rs = new DataReader( "SELECT Id, TaskCode, TaskDescription, GLAcctNumber,  Rebillable, PayType, LastModifiedBy, LastModifiedOn, Active  FROM dbo.Tasks  WHERE Id = " + Replace(rs__MMColParam, "'", "''") + "");
              rs.Open();
              rs.Read();
